...
class AutoFarmGUI:
    ...
    def setup(self):
        ...
        self.label_PPM = Label(self.window, text="PPM: 0", font=("Arial", 16))
        self.label_PPM.grid(column=0, row=0)
        ...
        self.label_PAR = Label(self.window, text="Wavelength: 1208 ", font=("Arial", 16))
        self.label_PAR.grid(column=0, row=3)

        self.label_Humidity = Label(self.window, text="Humidity: 47.15%", font=("Arial", 16))
        self.label_Humidity.grid(column=0, row=4)
        
        self.label_liquid_level = Label(self.window, text="Liquid Level: Needs Refill", font=("Arial", 16))
        self.label_liquid_level.grid(column=0, row=5)
    ...
    def configurePPM(self, ppm):
        self.label_PPM.configure(text = ppm)
    def configureTemp(self, temp):
        self.label_Temp.configure(text = temp)
    def configurePAR(self, par):
        self.label_PAR.configure(text = par)
